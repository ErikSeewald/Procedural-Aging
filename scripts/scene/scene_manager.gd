...
# SCENES
const scenes: Array = ["res://scenes/shader_testing.tscn", "res://scenes/demos/single_objects.tscn", "res://scenes/demos/docks.tscn", "res://scenes/profiling/profiling_main.tscn"]
var scene_index = 0
